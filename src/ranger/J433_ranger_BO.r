...
ksemilla_azar  <- 123997  #Aqui poner la propia semilla
...
setwd("C:\\Users\\JLeiva\\Downloads\\Mineria de datos\\labo\\exp\\HT4330\\")   #Establezco el Working Directory DEL EXPERIMENTO
