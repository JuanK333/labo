...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[ , mvr_relacionmobileappmov        := cmobile_app_trx / ctrx_quarter ]
  dataset[ , mvr_relacionhbankingmov         := chomebanking_trx  / ctrx_quarter ]
  dataset[ , mvr_relaciontranferenciamov     := ctransferencias_emitidas  / ctrx_quarter ]
  dataset[ , mvr_relacionconsumorentabilidad := mrentabilidad / mv_mconsumototal ]
  dataset[ , mvr_relacionsaldorentabilidad   := mrentabilidad / mcuentas_saldo]
  dataset[ , mvr_relacionsaldovisa           := Master_msaldototal / mcuentas_saldo ]
