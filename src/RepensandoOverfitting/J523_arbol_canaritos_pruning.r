...
setwd( "C:\\Users\\JLeiva\\Downloads\\Mineria de datos" )  #establezco la carpeta donde voy a trabajar
...
setwd("C:\\Users\\JLeiva\\Downloads\\Mineria de datos\\labo\\exp\\KA5230\\")   #Establezco el Working Directory DEL EXPERIMENTO
